...
'################# Data Arr변수 #################
Dim jcust_name, jcard_grade, jcard_num, jhp_num, jci, jcust_num
'################################################
On Error Resume Next
...
sqlStr = ""
sqlStr = sqlStr & " INSERT INTO db_outmall.dbo.tbl_syrupCheckLog (chk_successYN, ref, regdate, jdata, refip) VALUES ('P', 'pointview', getdate(), '"&sData&"', '"&refip&"') "
dbCTget.execute sqlStr
'##############################################################################################################
Call fnpointViewFlush(jseq_trans, jcust_name, jhp_num, jcard_num, jcust_num, jcard_grade, errCode)

sqlStr = ""
sqlStr = sqlStr & " INSERT INTO db_outmall.dbo.tbl_syrupCheckLog (chk_successYN, ref, regdate, jdata, refip) VALUES ('P', 'pointview_fin', getdate(), '"&sData&"', '"&refip&"') "
dbCTget.execute sqlStr
