...
sqlStr = "exec db_temp.[dbo].[usp_TEN_xSiteTmpMichulList_FinFlagDefaultSET] 'wmpfashion','"&confirmDt&"'"
...
sqlStr = "exec db_temp.[dbo].[usp_TEN_xSiteTmpMichulList_Maporder] 'wmpfashion','"&confirmDt&"'"
dbget.Execute sqlStr
rw "주문매핑"
...
function Get_WMPOrderListByStatus(stdate,eddate,iorderStatus,istatusName)
	dim sellsite : sellsite = "wmpfashion"
	...
	xmlURL = "http://110.93.128.100:8090/fwmp/Orders/orderlist"
