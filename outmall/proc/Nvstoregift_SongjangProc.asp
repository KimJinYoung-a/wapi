...
'response.end
	...
	strRst = strRst & "			</sel:AccessCredentials>"
	strRst = strRst & "			<sel:RequestID>ncp_1o1934_01</sel:RequestID>"
...
If mode = "updateSendState" Then
	...
	sqlStr = sqlStr & "	and sellsite='nvstoregift'"
...
if (IsSuccss) then
	...
	If errCount > 0 Then
		...
		response.write "    var uri = 'Nvstoregift_SongjangProc.asp?mode=updateSendState&ord_no='+ORG_ord_no+'&ord_dtl_sn='+ord_dtl_sn+'&updateSendState='+selectValue;"&VbCRLF
