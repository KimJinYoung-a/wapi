...
'response.end
	...
	strRst = strRst & "			</sel:AccessCredentials>"
	strRst = strRst & "			<sel:RequestID>tenten</sel:RequestID>"
...
If mode = "updateSendState" Then
	...
	sqlStr = sqlStr & "	and sellsite='nvstorefarm'"
...
if (IsSuccss) then
	...
	If errCount > 0 Then
		...
		response.write "    var uri = 'Nvstorefarm_SongjangProc.asp?mode=updateSendState&ord_no='+ORG_ord_no+'&ord_dtl_sn='+ord_dtl_sn+'&updateSendState='+selectValue;"&VbCRLF
