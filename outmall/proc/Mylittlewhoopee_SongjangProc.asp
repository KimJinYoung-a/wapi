...
If mode = "updateSendState" Then
	...
	sqlStr = sqlStr & "	and sellsite='Mylittlewhoopee'"
...
if (IsSuccss) then
	...
	If errCount > 0 Then
		...
		response.write "    var uri = 'Mylittlewhoopee_SongjangProc.asp?mode=updateSendState&ord_no='+ORG_ord_no+'&ord_dtl_sn='+ord_dtl_sn+'&updateSendState='+selectValue;"&VbCRLF
