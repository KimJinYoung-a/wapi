...
Set objJson = jsObject()
	Set objJson("header") = jsObject()
		objJson("header")("company_code") = company_code							'업체코드
		objJson("header")("company_auth") = company_auth							'인증코드
		Set objJson("delivery") = jsObject()
			objJson("delivery")("order_no") = ORG_ord_no							'주문번호
			objJson("delivery")("seq_no") = ord_dtl_sn								'일련번호
			objJson("delivery")("product_code") = outmallGoodNo						'상품코드
			objJson("delivery")("delivery_agency_code") = deliveryCompanyCode		'택배사코드
			objJson("delivery")("delivery_no") = inv_no								'배송번호
