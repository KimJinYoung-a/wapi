...
Class FilePost
  ...
  Private Function RandomBoundryGenerator()
    ...
    Dim nCount, sRet, nNumber, nLength, sValidChars
    Randomize
  ...
  Public Function PostFiles()
    Dim BoundryKey, BoundryStartKey, BoundryEndKey, PostToURL, Boundry, TotalTextBound, inputdata, inputname, inputvalue, strFileName
    Dim strFileExtention, strBoundry, fBoundry, MainStream, httpRequest
