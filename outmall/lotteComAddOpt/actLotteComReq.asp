...
If cmdparam = "RegSelectWait" Then
	...
	sqlStr = ""
	sqlStr = sqlStr & " INSERT into db_etcmall.[dbo].[tbl_lotteAddOption_regItem] "
	sqlStr = sqlStr & " (midx, regdate, reguserid, LotteStatCd)"
	sqlStr = sqlStr & " SELECT idx, getdate(), '"&session("SSBctID")&"', '00' "
	sqlStr = sqlStr & " FROM db_etcmall.[dbo].[tbl_Outmall_option_Manager] as M "
	sqlStr = sqlStr & " LEFT JOIN db_etcmall.[dbo].[tbl_lotteAddOption_regItem] R on M.idx = R.midx "
...
ElseIf (cmdparam = "DelSelectWait") Then
	If Right(arrIdx,1) = "," Then arrIdx = Left(arrIdx, Len(arrIdx) - 1)
	sqlStr = ""
	sqlStr = sqlStr & " DELETE FROM db_etcmall.[dbo].[tbl_lotteAddOption_regItem] "
...
<script type="text/javascript">
	...
	function arrSubmit(ino){
        ...
        document.frmSvArr.action = '/outmall/lotteComAddOpt/lotteComActProc.asp';
