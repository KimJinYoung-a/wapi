...
Dim iIdx, iMallid, iMidx
Dim arrItemidIdx

paramData = "redSsnKey=system&apiAction="&apiAction&"&mallid="&mallid&"&topN="&topN
arrItemidIdx = ""

If (application("Svr_Info") = "Dev") Then
	retVal = SendReqOutmall("http://localhost:11117/outmall/proc/QueOptionread.asp",paramData)
Else
	retVal = SendReqOutmall("http://wapi.10x10.co.kr/outmall/proc/QueOptionread.asp",paramData)
End If
...
If (IsSuccess(retVal)) Then
	...
	For i = Lbound(rowsVal) To Ubound(rowsVal)
		...
		If Ubound(colsVal) >= 2 Then
			...
			iMallid	= colsVal(1)
			iMidx	= colsVal(2)
			arrItemidIdx = arrItemidIdx & iMidx & "##" & iIdx & ","
		End If
	Next
