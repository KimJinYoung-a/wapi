...
If (application("Svr_Info") = "Dev") Then
	retVal = SendReqOutmall("http://localhost:11117/outmall/proc/Queread.asp",paramData)
Else
	retVal = SendReqOutmall("http://wapi.10x10.co.kr/outmall/proc/Queread.asp",paramData)
End If
