...
IF application("Svr_Info") = "Dev" THEN
	eCode   =  66105		''4ten 텐바이텐
Else
	eCode   =  70032		''4ten 텐바이텐
End If
...
If userid="thensi7" Or userid="kobula" Or userid="bborami" Or userid="tozzinet" Or userid="baboytw" Or userid="bjh2546" Or userid="ascreem" Then
Else
